...
export const appRoutes: Route[] = [
    ...
    // Redirect empty path to '/usuarios'
    ...
    // Admin routes
    {
        ...
        children: [
            //{path: 'bienvenida', loadChildren: () => import('app/modules/admin/bienvenida/bienvenida.module').then(m => m.BienvenidaModule)},
            {path: 'usuarios', loadChildren: () => import('app/modules/admin/usuarios/usuarios.module').then(m => m.UsuariosModule)},
            {path: 'viajes', loadChildren: () => import('app/modules/admin/viajes/viajes.module').then(m => m.ViajesModule)},
